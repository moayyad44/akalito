...
`google-services.json` **غير مرفوع بهذا المستودع بعد** (لسا مؤيد ما حمّله
بالخطوة رقم 3 أعلاه) — لو حاولت تبني الـ APK قبل إضافته، رح يبنى ويشتغل عادي،
بس إشعارات الدفع فقط هي اللي ما رح تشتغل لحد ما يُضاف الملف.
